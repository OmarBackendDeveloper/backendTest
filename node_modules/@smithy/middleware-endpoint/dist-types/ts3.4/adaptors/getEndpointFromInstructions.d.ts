...
import { EndpointResolvedConfig } from "@smithy/middleware-endpoint/dist-types/ts3.4/resolveEndpointConfig";
import { EndpointParameterInstructions } from "@smithy/middleware-endpoint/dist-types/ts3.4/types";
/**
 * @internal
 */
