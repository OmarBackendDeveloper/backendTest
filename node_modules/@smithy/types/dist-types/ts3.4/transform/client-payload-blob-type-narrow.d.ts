...
import { InvokeFunction, InvokeMethod } from "@smithy/types/dist-types/ts3.4/client";
import { HttpHandlerOptions } from "@smithy/types/dist-types/ts3.4/http";
import { SdkStream } from "@smithy/types/dist-types/ts3.4/serde";
import { BrowserRuntimeStreamingBlobPayloadInputTypes, NodeJsRuntimeStreamingBlobPayloadInputTypes, StreamingBlobPayloadInputTypes } from "@smithy/types/dist-types/ts3.4/streaming-payload/streaming-blob-payload-input-types";
import { NarrowedInvokeFunction, NarrowedInvokeMethod } from "@smithy/types/dist-types/ts3.4/transform/client-method-transforms";
import { Transform } from "@smithy/types/dist-types/ts3.4/transform/type-transform";
/**
 * @public
 *
