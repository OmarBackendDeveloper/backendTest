import { HttpRequest } from "@smithy/types/dist-types/ts3.4/http";
import { FinalizeHandler, FinalizeHandlerArguments, FinalizeHandlerOutput, HandlerExecutionContext } from "@smithy/types/dist-types/ts3.4/middleware";
