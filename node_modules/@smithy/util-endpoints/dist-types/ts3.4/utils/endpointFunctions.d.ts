export declare const endpointFunctions: {
    ...
    getAttr: (value: import("@smithy/util-endpoints/dist-types/ts3.4/lib").GetAttrValue, path: string) => import("@smithy/util-endpoints/dist-types/ts3.4/lib").GetAttrValue;
